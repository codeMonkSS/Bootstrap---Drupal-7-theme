// jQuery Plugin - Bootstrap Slide Show
// Version 0.1
...
(function($) {
    ...
    // here it goes!
    $.fn.bootstrapSlideShow = function(method) {
        ...
        // element.bootstrapSlideShow('methodName', arg1, arg2, ... argn)
        // where "element" is the element the plugin is attached to, "bootstrapSlideShow" is the name of your plugin and
        ...
        var methods = {
            ...
            init : function(options) {
                ...
                this.bootstrapSlideShow.settings = $.extend({}, this.bootstrapSlideShow.defaults, options);
        ...
        // otherwise
            ...
            // trigger an error
            $.error( 'Method "' +  method + '" does not exist in bootstrapSlideShow plugin!');
    ...
    $.fn.bootstrapSlideShow.defaults = {
    ...
    // this.bootstrapSlideShow.settings.propertyName from inside the plugin or
    // element.bootstrapSlideShow.settings.propertyName from outside the plugin, where "element" is the element the
    // plugin is attached to;
    $.fn.bootstrapSlideShow.settings = {}
